...
const { users, pendingToggle,toggleStatusUser, pending, deleteUser, pendingDelete,clearCacheUser, pendingClearCache } = useUsers(currentPage, 'kepegawaian')
// console.log(users)
        ...
        <div>
            <section class="mb-3">
                ...
                <div v-else  class="px-3 m-3">   
                    ...
                    <NuxtLink to="/dashboard/admin/kepegawaian/tambah" class="px-3 py-1  text-xs w-fit font-semibold rounded-full flex items-center   gap-2 bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300">
